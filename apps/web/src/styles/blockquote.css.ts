...
import { darkMode, theme } from '@/styles/theme.css';
...
globalStyle('[class^=blockquote-]', {
  ...
  borderRadius: rem(10),
  transition:
    'color 300ms cubic-bezier(0.4, 0, 0.2, 1), border-color 300ms cubic-bezier(0.4, 0, 0.2, 1), background-color 300ms cubic-bezier(0.4, 0, 0.2, 1)',
});
