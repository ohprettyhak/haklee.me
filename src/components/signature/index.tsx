...
import { ComponentProps, FC, ReactElement, useRef } from 'react';
...
export const Signature: FC<SignatureProps> = ({ className, ...props }): ReactElement => {
  ...
  return (
    <div className={clsx(className, styles.root)} ref={ref} data-animate={isInView} {...props}>
      <svg className={styles.signature} width="739" height="298" viewBox="0 0 739 298" fill="none">
        <path
